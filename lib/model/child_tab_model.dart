...
class ChildTabModel {
  ...
  int errorCode;
  String errorMsg;
  ChildTabModelData data;

  ChildTabModel.fromParams({this.errorCode, this.errorMsg, this.data});

  factory ChildTabModel(jsonStr) => jsonStr == null ? null : jsonStr is String ? new ChildTabModel.fromJson(json.decode(jsonStr)) : new ChildTabModel.fromJson(jsonStr);

  ChildTabModel.fromJson(jsonRes) {
    errorCode = jsonRes['errorCode'];
    errorMsg = jsonRes['errorMsg'];
    data = jsonRes['data'] == null ? null : new ChildTabModelData.fromJson(jsonRes['data']);
  }
...
class ChildTabModelData {
  ...
  int total;
  bool over;
  List<ChildTabModelDatas> datas;

  ChildTabModelData.fromParams({this.curPage, this.offset, this.pageCount, this.size, this.total, this.over, this.datas});

  ChildTabModelData.fromJson(jsonRes) {
    ...
    for (var datasItem in datas == null ? [] : jsonRes['datas']){
      datas.add(datasItem == null ? null : new ChildTabModelDatas.fromJson(datasItem));
    }
  }
...
class ChildTabModelDatas {
  ...
  ChildTabModelDatas.fromParams({this.chapterId, this.courseId, this.id, this.publishTime, this.superChapterId, this.type, this.userId, this.visible, this.zan, this.collect, this.fresh, this.apkLink, this.author, this.chapterName, this.desc, this.envelopePic, this.link, this.niceDate, this.origin, this.prefix, this.projectLink, this.superChapterName, this.title, this.tags});

  ChildTabModelDatas.fromJson(jsonRes) {
