...
class HomeList {
  ...
  HomeList.fromParams({this.errorCode, this.errorMsg, this.data});

  factory HomeList(jsonStr) => jsonStr == null ? null : jsonStr is String ? new HomeList.fromJson(json.decode(jsonStr)) : new HomeList.fromJson(jsonStr);

  HomeList.fromJson(jsonRes) {
    errorCode = jsonRes['errorCode'];
    errorMsg = jsonRes['errorMsg'];
    data = jsonRes['data'] == null ? null : new HomeListData.fromJson(jsonRes['data']);
  }
...
class HomeListData {
  ...
  HomeListData.fromParams({this.curPage, this.offset, this.pageCount, this.size, this.total, this.over, this.datas});
  ...
  HomeListData.fromJson(jsonRes) {
    ...
    for (var datasItem in datas == null ? [] : jsonRes['datas']){
      datas.add(datasItem == null ? null : new HomeListDatas.fromJson(datasItem));
    }
  }
...
class HomeListDatas {
  ...
  String title;
  List<HomeListDatasTag> tags;

  HomeListDatas.fromParams({this.chapterId, this.courseId, this.id, this.publishTime, this.superChapterId, this.type, this.userId, this.visible, this.zan, this.collect, this.fresh, this.apkLink, this.author, this.chapterName, this.desc, this.envelopePic, this.link, this.niceDate, this.origin, this.projectLink, this.superChapterName, this.title, this.tags});

  HomeListDatas.fromJson(jsonRes) {
    ...
    for (var tagsItem in tags == null ? [] : jsonRes['tags']){
      tags.add(tagsItem == null ? null : new HomeListDatasTag.fromJson(tagsItem));
    }
  }
...
class HomeListDatasTag {

  String name;
  String url;

  HomeListDatasTag.fromParams({this.name, this.url});

  HomeListDatasTag.fromJson(jsonRes) {
    name = jsonRes['name'];
    url = jsonRes['url'];
  }
