...
class WanBanner {
  ...
  WanBanner.fromParams({this.errorCode, this.errorMsg, this.data});

  factory WanBanner(jsonStr) => jsonStr == null ? null : jsonStr is String ? new WanBanner.fromJson(json.decode(jsonStr)) : new WanBanner.fromJson(jsonStr);

  WanBanner.fromJson(jsonRes) {
...
class Data {
  ...
  Data.fromParams({this.id, this.isVisible, this.order, this.type, this.desc, this.imagePath, this.title, this.url});
